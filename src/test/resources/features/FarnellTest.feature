...
Scenario: 1. Verify that the user able to navigate to Farnell page Successfully and assert that FarnellLogo launched
Given user navigate to Farnell Home page
When user clicked on cookie accept button
Then validate Farnell Logo

Scenario: 2. Verify user able to complete registration successful
